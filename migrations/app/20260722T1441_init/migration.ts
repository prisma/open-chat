    ...
    return [
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('userId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('zeroAt', 'timestamptz', { codecRef: { codecId: 'pg/timestamptz@1' } }),
        ],
        constraints: [primaryKey(['id'])],
      }),
      this.createTable({
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('creditMicroUsd', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('feeMicroUsd', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('kind', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('paidMicroUsd', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('stripeSessionId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('updatedAt', 'timestamptz', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamptz@1' },
          }),
      ...
      this.createTable({
        ...
        table: 'usage',
        columns: [
          col('costMicroUsd', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('createdAt', 'timestamptz', {
            notNull: true,
            default: fn('now()'),
            codecRef: { codecId: 'pg/timestamptz@1' },
          ...
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('inputTokens', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('outputTokens', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('isAnonymous', 'bool', { codecRef: { codecId: 'pg/bool@1' } }),
      ...
      this.addUnique({
        schema: 'public',
        table: 'billing',
        constraint: 'billing_userId_key',
        columns: ['userId'],
      }),
      this.addUnique({
        schema: 'public',
        table: 'credit_grant',
        constraint: 'credit_grant_stripeSessionId_key',
      ...
      this.addUnique({
        schema: 'public',
        table: 'usage',
        constraint: 'usage_userId_period_key',
      ...
      this.createIndex({
        schema: 'public',
        table: 'chat',
        index: 'chat_userId_updatedAt_idx',
      ...
      this.createIndex({
        schema: 'public',
        table: 'content',
        index: 'content_userId_idx',
        columns: ['userId'],
      }),
      this.createIndex({
        schema: 'public',
        table: 'credit_grant',
        index: 'credit_grant_userId_idx',
        columns: ['userId'],
      }),
      this.createIndex({
        schema: 'public',
